...
require (
	...
	pkg.package-operator.run/boxcutter v0.1.2-0.20250624103119-6012f3de9061
...
replace pkg.package-operator.run/boxcutter => github.com/radimous/boxcutter ot-cache